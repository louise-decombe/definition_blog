...
class __TwigTemplate_0659f7dd405e84817db13cd103d21943d0a822bca8ef163ca36fc7e236958a2d extends Template
{
    private $source;
    private $macros = [];
...
<form method=\"post\">
    ...
    {% if app.user %}
        <div class=\"mb-3\">
            Vous êtes connecté(e)s en tant que {{ app.user.username }}, <a href=\"{{ path('app_logout') }}\">Déconnexion</a>
        </div>
    {% endif %}
...
{% endblock %}
", "security/login.html.twig", "/opt/lampp/htdocs/definition-blog/templates/security/login.html.twig");
    }
}

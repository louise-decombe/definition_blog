...
class __TwigTemplate_574bfbe3f7f9977289e5cf4e0240c95acff96d58aa12b868342f26c0cb30222e extends Template
{
    private $source;
    private $macros = [];
...
{% else %}
    <a href=\"mailto:{{ field.value }}\">{{ field.formattedValue }}</a>
{% endif %}
", "@EasyAdmin/crud/field/email.html.twig", "/opt/lampp/htdocs/definition-blog/vendor/easycorp/easyadmin-bundle/src/Resources/views/crud/field/email.html.twig");
    }
}
